...
const adminController = {
    createAdmin: async (req, res) => {
        try {
            ...
            await newAdmin.save();
            res.status(201).json({ message: "Administrador agregado correctamente", newAdmin });
        }
        catch (error) {
...
getAdmins: async (req, res) => {
    ...
    deleteAdmin: async (req, res) => {
        try {
            ...
            res.status(200).json({ message: "Administrador eliminado correctamente", deletedAdmin });
        } catch (error) {
